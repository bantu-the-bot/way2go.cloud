...
const Mermaid = ({ chart }: { chart: string }) => {
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center">
      {error && (
        <div className="absolute inset-0 z-10 flex items-center justify-center bg-white/90 backdrop-blur-sm p-6 text-center">
          <div className="max-w-md">
            ...
            <h3 className="text-lg font-bold text-slate-900 mb-2">Rendering Error</h3>
